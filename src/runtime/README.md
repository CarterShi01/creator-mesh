...
`src/runtime` owns CreatorMesh's execution runtime. It receives already-framed execution work from workflows, dispatches steps to agents, runners, and connectors, applies governance checks before side effects, and supports pause/resume behavior.
...
- Direct UI code
- Domain models or semantic interpretation — pass structured workflow inputs in instead
