# CreatorMesh Control Plane (Phase 1 Borrow)

This directory contains all documentation for the current Phase 1 dispatch control plane.

For the unified strategic north star, see [`../blueprint.md`](../blueprint.md).
